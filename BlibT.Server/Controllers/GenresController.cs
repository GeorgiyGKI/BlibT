...
namespace WebLibWebApi.Controllers
{
    ...
    public class GenresController : ControllerBase
    {
        ...
        public GenresController(IServiceManager service) => _service = service ?? throw new ArgumentNullException(nameof(service));
        ...
        [HttpGet("GenresByBookId/{id:int}")]
        public async Task<IActionResult> GetGenresByBookId(int id)
        {
            var genres = await _service.GenreService.GetGenresByBookId(id, trackChanges: false);
